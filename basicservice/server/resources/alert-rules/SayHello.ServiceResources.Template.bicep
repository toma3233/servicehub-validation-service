...
module errorRatioAlertRule 'br/public:avm/res/insights/scheduled-query-rule:0.1.2' = {
  name: 'basicservice-SayHello-error-ratio'
  scope: resourceGroup(subscriptionId, resourceGroupName)
  params: {
    name: 'basicservice-SayHello-error-ratio'
    location: location
    alertDescription: 'This is the alert for basicservice for the calculated metric error ratio.'
    criterias: {
      allOf: [
        {
...
module latencyAlertRule 'br/public:avm/res/insights/scheduled-query-rule:0.1.2' = {
  name: 'basicservice-SayHello-latency-by-error-code'
  scope: resourceGroup(subscriptionId, resourceGroupName)
  params: {
    name: 'basicservice-SayHello-latency-by-error-code'
    location: location
