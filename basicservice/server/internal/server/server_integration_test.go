...
import (
	...
	"dev.azure.com/service-hub-flg/service_hub_validation/_git/service_hub_validation_service.git/basicservice/api/v1/client"
	"dev.azure.com/service-hub-flg/service_hub_validation/_git/service_hub_validation_service.git/basicservice/api/v1/restsdk"
	"dev.azure.com/service-hub-flg/service_hub_validation/_git/service_hub_validation_service.git/basicservice/server/internal/logattrs"
...
var _ = Describe("REST call test", func() {
	...
	Context("when sending a REST request", func() {
		It("should return successfully when making SayHello call", func() {
			...
			resp, _, err := service.BasicServiceSayHello(context.Background(), helloRequestBody)
