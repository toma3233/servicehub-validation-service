...
require (
	dev.azure.com/service-hub-flg/service_hub_validation/_git/service_hub_validation_service.git/mygreeterv3/api v0.0.2
	github.com/Azure/aks-async v0.0.29
...
require (
	...
	github.com/Azure/go-shuttle/v2 v2.7.2 // indirect
