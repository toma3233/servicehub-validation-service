...
func init() {
	...
	startCmd.Flags().StringVar(&options.ServiceBusHostName, "service-bus-hostname", "servicehubval-resourceName-servicebus-namespace.servicebus.windows.net", "The host name used to connect to the service bus.")
