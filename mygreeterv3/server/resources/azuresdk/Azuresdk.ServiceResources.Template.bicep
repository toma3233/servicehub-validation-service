...
resource serviceBusNamespace 'Microsoft.ServiceBus/namespaces@2022-10-01-preview' existing = {
  name:  'servicehubval-${resourcesName}-servicebus-namespace'
...
module aks 'br:servicehubregistry.azurecr.io/bicep/modules/aks-managed-cluster:v5' = {
  name: 'servicehubval-${resourcesName}-clusterDeploy'
  scope: resourceGroup(subscriptionId, resourceGroupName)
  params: {
...
var serviceAccountNamespace = 'servicehubval-mygreeterv3-server'
var serviceAccountName = 'servicehubval-mygreeterv3-server'
module managedIdentity 'br/public:avm/res/managed-identity/user-assigned-identity:0.2.1' = {
  ...
  params: {
    ...
    federatedIdentityCredentials: [
      {
        name: 'servicehubval-${resourcesName}-mygreeterv3-fedIdentity'
